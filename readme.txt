...
= Updates = 
* Fix reported bug with some themes
...
Please note: We strongly recommend turning off trackbacks and pingbacks in Discussion Settings, as well as ensuring that users must be registered and logged in to comment. See Dashboard>Settings>Discussion to confirm.
