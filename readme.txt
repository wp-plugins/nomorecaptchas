...
* Automatic protection for comments
* More free verifications each month
...
NoMoreCaptchas is free for personal use and for registered charities. For companies and other groups with needs beyond the personal blog or small site, we offer subscription-based services. 
For more information, please visit http://www.NoMoreCaptchas.com

Note: Be sure to register (it's free!) at http://nomorecaptchas.com/#!/register to activate your NoMoreCaptchas and keep those bots away!
...
1: Register  
Even if you're using NMC for free, you have to register to enjoy its protection. It takes 2 minutes - just go to http://nomorecaptchas.com/#!/register to receive your License Key. 
...
Please note: We strongly recommend turning off trackbacks and pingbacks in the WordPress Discussion Settings. They’re a back door for spam to exploit no matter what kind of protection you have.
...
Yes. You can install and use NoMoreCaptchas for free for personal use and for registered charities and enjoy protection for up to 10,000 bot attacks per month. That is plenty for most small sites.
...
Yes. We have tested it up to the latest release (BuddyPress 2.3.2.1) and it is compatible.
...
For Contact Form 7, it’s automatic. If you use something different, please let us know and we can look into putting it in our development queue. 

= How can I tell if NoMoreCaptchas is working? =
Seeing NoMoreCaptchas in action is believing, and there's no better place to see it happen than your Dashboard. With version 2.0, your dashboard is located on your site under Dashboard>Settings> NoMoreCaptchas.
...
* This bit of spam was in the queue and your site pushed it live after NoMoreCaptchas was installed. Queues tend to lag up to 48 hours behind what goes live. Check your pending comments and users to make sure you don’t have a queue built up.
...
* If that's not the case, then make sure your License Key was not properly entered into the control panel. Please be sure to copy and paste it directly from the email we sent you. If you no longer have your License Key, please contact us at support@nomorecaptchas.com so we can send you a new one.
...
To get your License Key, register your site with us at http://nomorecaptchas.com/#!/register. As soon as you do, we'll send you your license key.
...
3. You can see it in action on your Dashboard. Check who is being let in and what's being blocked - and what pages they are trying to access.
